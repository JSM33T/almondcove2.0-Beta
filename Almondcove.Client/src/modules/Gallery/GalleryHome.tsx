                ...
                <div className="row pt-2">
                    <div className="col-lg-6 d-flex flex-column mb-4 mb-lg-0 pb-sm-3 pb-lg-0 aos-init aos-animate" data-aos="fade" data-aos-duration="500" data-aos-offset="50" data-disable-parallax-down="md" data-disable="md">
                        ...
                        <ul className="nav mt-auto mx-n2 pt-sm-3 pt-lg-0">
                            <li className="nav-item me-3"><a className="nav-link p-2" target="_blank" href="https://www.youtube.com/@JSM33T">youtube</a></li>
                            <li className="nav-item me-3"><a className="nav-link p-2" target="_blank" href="https://soundcloud.com/jsm33t">soundcloud</a></li>
                            <li className="nav-item"><a className="nav-link p-2" target="_blank" href="https://www.instagram.com/thecoffeeroominsta/">instagram</a></li>
                        </ul>
                    </div>

                    <div className="col-lg-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
                        <img src="https://almondcove.in/assets/images/covers/studio-cover.png" alt="Studio Cover" />
                    </div>
                </div>
            </section>
        </div>
