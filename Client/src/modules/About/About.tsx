    ...
    return (
        <>
            <section className="position-relative pt-sm-4">
                <div className="container position-relative zindex-5 mt-2 pt-2 pb-2 pb-sm-4 pb-lg-5">
                    <h1 className="display-3 text-center mx-auto pt-5 my-2 my-sm-4">Almondcove</h1>
                    <h6 className="text-muted text-center mx-auto aos-init aos-animate" data-aos="flip-up" data-aos-duration="200" data-aos-offset="50" data-disable-parallax-down="md" data-disable="md">by jsm33t</h6>
            ...
            <section className="container pt-2 mt-lg-2 mt-xl-2 mt-xxl-2">
                <div className="pt-2 pt-sm-3 mt-md-3">
                    <p className="fs-lg aos-init aos-animate" data-aos="fade" data-aos-duration="500" data-aos-offset="50" data-disable-parallax-down="md" data-disable="md">
                        Welcome to the digital santuary of AlmondCove, and thank you for taking the time to get to know the person behind the lens, the notes, and the code.
                        I'm <span className="text-primary">Jass </span>(jsm33t), the founder.I am a full-stack web developer on weekdays and a music producer/hobbyist on weekends with a keen interest in urban exploration and mobile photography.
                    </p>
                    <p className="fs-lg aos-init aos-animate" data-aos="fade" data-aos-duration="800" data-aos-offset="50" data-disable-parallax-down="md">
